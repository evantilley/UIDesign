...
mushrooms = [
    {
        ...
        "Comments": [
            ["I love these mushrooms!", {"mark_as_deleted": "false"}, {"undo": "false"}],
            ["Made these the other day with my husband - great with pasta!", {"mark_as_deleted": "false"}, {"undo": "false"}],
            ["These mushrooms are super cute :D", {"mark_as_deleted": "false"}, {"undo": "false"}]
        ]
    },
        {
        "Id": 1,
        ...
        "Comments": [
            ["These mushrooms look so mushroom-like haha", {"mark_as_deleted": "false"}, {"undo": "false"}],
            ["Do not eat these raw! I tried this and I felt nauseous and awful.", {"mark_as_deleted": "false"}, {"undo": "false"}],
            ["Nice.", {"mark_as_deleted": "false"}, {"undo": "false"}]
        ]
    },
        {
        "Id": 2,
        ...
        "ApproximateCapSize": 6,
        "Comments": [
            ["Had these the other day at an Asian restaraunt - soooo good!", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Ah shiitake! Forgot to take out the trash yesterday and now it smells.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["I found these the other day in a forest and wondered what they were called. Now I know. Thanks, mushrooms.com!", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
    {
        "Id": 3,
        ...
        "Comments": [
            ["Destroying angel... now there's a scary name", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Found those in the woods the other day, thank god I checked this site before trying to cook it", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["My uncle's dog died from eating one of these :( please avoid death caps at all costs.", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
    {
        "Id": 4,
        ...
        "ApproximateCapSize": 6,
        "Comments": [
            ["LOL these really do look like oysters! I thought there was an oyster growing out of a tree in my backyard at first and was like 'What?!'", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Oyster gang", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["I love these! My grandfather is from Japan and uses Pearl Oyster Shrooms all the time when cooking!", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
        {
        "Id": 5,
        ...
        "Comments": [
            ["I heard that Hofmann tried about 32 of these after growing them himself. Must of been an interesting time, to see the least.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Crazy how signicant the presence of hallucinogenic mushrooms are in ancient societies.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Never again...", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
            {
        "Id": 6,
        ...
        "Comments": [
            ["Whew, thank god I consulted this site, I found something in the woods that's I was about to give to my daughter! Based on the picture here though, I'm pretty sure they're magic mushrooms, so I will not be feeding this to my daughter any time soon.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Huh, I didn't realize there were different species of hallucinogenic mushrooms, interesting", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["$15/teenth - email me at susmans@mushrooms.com", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Fascinating!", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
        {
        "Id": 7,
        ...
        "ApproximateCapSize": 5,
        "Comments": [
            ["These mushrooms are the besttt omg. They're super crunchy and sweet and are great to add to a stir fry.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Aww hedeghog mushrooms :D", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
    {
        "Id": 8,
        ...
        "ApproximateCapSize": 4,
        "Comments": [
            ["I stepped one of these last week and thought I had started a fire because of the smoke-looking power LOL", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["These ones are soo cute :) I wanna eat one!", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
        {
        "Id": 9,
        ...
        "ApproximateCapSize": .5,
        "Comments": [
            ["I love these guys! They're super small and go great in Asian stir fries.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Always be careful if you think you find one of these in the wild - it could be a death cap D:", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
    {
        "Id": 10,
        ...
        "ApproximateCapSize": 2,
        "Comments": [
            ["Sometimes I use these with blanched eggs.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["LOL I'm pretty sure they hunt these out with specially trained truffle hogs. Oink Oink!", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["These are too expensive for me.", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
     {
        "Id": 11,
        ...
        "Comments": [
            ["Damn, mushrooms can cure cancer now! What can't they do?", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["These are so ruffly haha", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["I see these all the time where I live. Sometimes trees are covered in them!", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
    {
        "Id": 12,
        ...
        "ApproximateCapSize": 2,
        "Comments": [
            ["Lmao these legit taste like air to me", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Found these in my backyard a few months back! Cooked them for dinner and was not disappointed!", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Bruh just fry chicken don't eat some weird mushroom.", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
     {
        "Id": 13,
        ...
        "ApproximateCapSize": 1,
        "Comments": [
            ["Bruh chill with these mushrooms", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Wouldn't recommend eating these unless you know what you're doing", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["These are also used as an aphrodisiac in some places!", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
    {
        "Id": 14,
        ...
        "ApproximateCapSize": 3,
        "Comments": [
            ["Haha these mushrooms are funny. I tried to pick one up once and it slipped out of my hand because of the slippery cap.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["My wife and I tried this with a stir fry on Tuesday. Wasn't bad.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Yeyeyeyeye", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
    {
        "Id": 15,
        "Species": "Boletus edulis",
        "Image": "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Boletus_edulis_EtgHollande_041031_091.jpg/351px-Boletus_edulis_EtgHollande_041031_091.jpg",
        "Edible": "Yes.",
        "Info": "Boletus edulis mushrooms are relatively large light brown mushrooms. They grow in deciduous and coniferous forests and can be found all over the globe, from North American to China. Penny Buns are considered one of the safest wild mushrooms to pick, as few poisonous species closely resemble it. The mushrooms taste nutty and slightly meaty and are often used in soup and sautées.",
        "CommonNames": [
            "Penny Bun",
            "Hog Mushroom"
        ],
        "ApproximateCapSize": 7,
        "Comments": [
            ["Try eating these raw! Even without any additional flavoring they are surprisingly tasty!", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Beans", {"mark_as_deleted": "false"},{"undo": "false"}],
        ]
    },
        {
        "Id": 16,
        ...
        "ApproximateCapSize": 1,
        "Comments": [
            ["These are a rare find. Remember the homies and I at home got our hands on them once. Was a fun night", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["What?! They stain blue? That's weird LOL", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["We call 'em olive caps where I'm from", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
        {
        "Id": 17,
        ...
        "ApproximateCapSize": 2,
        "Comments": [
            ["These are some cool looking mushrooms", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Yellow4dayz", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Visited the Faeroe Islands once with my girlfriend. Such an awesome time. We ended up having our wedding there a few years later. Sadly, we got divorced after I found out she had been stealing money from our local Mormon church :'(. Oh well, life happens I suppose.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["^ Aww that's too bad man, hope you find someone else :)", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
    {
        "Id": 18,
        ...
        "ApproximateCapSize": 3,
        "Comments": [
            ["Okay, so let me get this straight: some mushrooms might be able to cure cancer, and some mushrooms might cause cancer?! Christ, make up your mind mushrooms!", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Helluva Helvella mushroom lmao", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Beans are good", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
     {
        "Id": 19,
        ...
        "ApproximateCapSize": 1,
        "Comments": [
            ["These mushrooms are so red!", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["I live in Europe and found a few of these growing in my fields once! I ate them and they tasted like nothing LOL", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Cool shrooms", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
        {
        "Id": 20,
        ...
        "ApproximateCapSize": 3,
        "Comments": [
           ["Oo this really is like a Jack-o'-lantern! It's orange and glows in the dark!", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Aww, too bad these are poisonous, they look like they would taste good lol", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
        {
        "Id": 21,
        ...
        "ApproximateCapSize": 2,
        "Comments": [
            ["I ordered spores for these the other day. I want to grow them to see if they actually do glow in the dark!", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["I love mushrooms.", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
        {
        "Id": 22,
        ...
        "ApproximateCapSize": 2,
        "Comments": [
            ["Mushrooms that taste like apricots?! I have to try!", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["I think I found one of these while taking a nature walk, but I'm a bit hesitant about eating it - I want to make sure its not a Jack-o'-lantern mushroom.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Pro-tip: Don't put these in the oven or else they become bitter!", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
    {
        "Id": 23,
        ...
        "ApproximateCapSize": 3,
        "Comments": [
            ["Whoo, go Oregon! Born and raised in Seattle. Never saw one of these mushrooms, but I guess that's because I lived in Seattle haha", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Interesting note: Pacific golden Chanterelle mushrooms have a pinkish hue on their false gills.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Mushrooms are so colorful! Who doesn't love them?!", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
    {
        "Id": 24,
        ...
        "Comments": [
            ["These mushrooms are MASSIVE!. As a senior in college I studied abroad in Japan (I majored in Japanese History). My host family's house had a huge forest in the back and I'd often walk around, marveling at the huge clusters of these growing on the trees. I used to joke with my hosts that the weight of the mushrooms would bring the trees down LOL. Haha good times. Wish I was back there. Currently serving 2 years in prison for siphoning gas from my neighbor's car. Then I'll be back to teaching Japanense History!", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["^You good?", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["I love these! Had these in many dishes when I visited China!", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
        {
        "Id": 25,
        ...
        "ApproximateCapSize": "N/A",
        "Comments": [
            ["Great mushroom! Stumbled upon a few clumps of these while walking in the woods and, after reading about them on this site, decided to blanche them. Made a great meal for the husband and kids.", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["These have a surprisingly meaty texture lol, I was surprised. Not bad though", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Fungus looking bois", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
        {
        "Id": 26,
        ...
        "ApproximateCapSize": 2,
        "Comments": [
            ["If you're ever lucky enough to find yourself in a situation where you can eat these mushrooms, try them! They're soo good!", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Morbid name D:", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Huh, wonder how these compare to black truffles.", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
        {
        "Id": 27,
        ...
        "ApproximateCapSize": "N/A",
        "Comments": [
            ["Knew a guy that spent a good few months searching for these. He said they did indeed taste similar to Black Trumpets", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["These mushrooms are literattly just a huge clump of black fungi on the ground. Super hard to spot.", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
        {
        "Id": 28,
        ...
        "ApproximateCapSize": 6,
        "Comments": [
            ["Would really recommend grilling these and serving with other vegetables! Great mushroom 10/10 would recommend", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["If only these made you as drunk as Burgundy haha", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
     {
        "Id": 29,
        ...
        "Edible": "Hallucinogenic.",
        "Info": "Psilocybe semilanceata mushrooms are one of the most potent hallucinogenic mushrooms. They are notable for their bell-shaped cap and grow in wet grassland habitats, most commonly in regions of Europe. The first documentation of Liberty Caps was by a British Family in 1799 who ate the mushrooms with a meal. The father and children subsequently had a psychedelic experience.",
        "CommonNames": [
            "Liberty Cap"
        ],
        "ApproximateCapSize": 1,
        "Comments": [
            ["Freeing...", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Crazy what mushrooms can do! Some can cause cancer, some can cure cancer, and some can make you hallucinate!", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    },
    {
        "Id": 30,
        ...
        "Comments": [
            ["Stumbled upon one of these a few days ago, I didn't even realize it was a mushroom!", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["Damn haha, haven't thought of this mushroom in ages. Tried them once in college while studying abroad since someone told me they're good for treating anxiety. College was a dark time for me. Safe to say these mushrooms didn't help much", {"mark_as_deleted": "false"},{"undo": "false"}],
            ["OMG so fuzzy!", {"mark_as_deleted": "false"},{"undo": "false"}]
        ]
    }
]
source = []
...
def view(id = None):
    ...
    return render_template('template.html', mushroom = mushrooms[int(id)], mushrooms = mushrooms, source = source)

#Note: appending the query "term" to the URL was not necessary but I thought
#this was better style
@app.route('/search/<term>')
def search(term = None):
    print("search term being sent is", search_term)
    return render_template('search.html', mushrooms = mushrooms, source = source, search_term = term)

@app.route('/create', methods = ['GET', 'POST'])
def create():
    return render_template('create.html', mushrooms = mushrooms, source = source)
...
def add_search():
    ...
    json_data = request.get_json()
    print(json_data)
    search_term = json_data["search"]
    json_return = {"search_term": search_term}
    print("returning", json_return)
    return jsonify(search_term = json_return)


# @app.route('/layout')
# def layout():
#     print("asdjfhasdf")
#     return render_template('layout.html', mushrooms = mushrooms)

#for deleting entire database entry - used in PSET 6
...
def delete_comment():
    json_data = request.get_json()
    id = json_data["Id"] #mushroom id
    comment_id = json_data["comment-id"]
    print(comment_id)
    for i in range (len(mushrooms)):
        if i == id:
            mushroom = mushrooms[i]
            mushrooms[i]["Comments"][int(comment_id)][1] = {"mark_as_deleted": "true"}
            mushrooms[i]["Comments"][int(comment_id)][2] = {"undo": "true"}
    return jsonify(mushroom = mushroom)

@app.route('/undo_comment', methods = ['GET', 'POST'])
def undo_comment():
    json_data = request.get_json()
    id = json_data["Id"] #mushroom id
    comment_id = json_data["comment-id"]
    for i in range(len(mushrooms)):
        if i == id:
            mushroom = mushrooms[i]
            mushrooms[i]["Comments"][int(comment_id)][1] = {"mark_as_deleted": "false"}
            mushrooms[i]["Comments"][int(comment_id)][2] = {"undo": "true"}
    return jsonify(mushroom = mushroom)
...
def add_comment():
    ...
    for i in range(len(mushrooms)):
        if i == id:
            mushroom = mushrooms[i]
            mushrooms[i]["Comments"].append([comment, {"mark_as_deleted": "false"},{"undo": "false"}])

    for i in range(len(mushrooms)):
        for j in range(len(mushrooms[i]["Comments"])):
            mushrooms[i]["Comments"][j][2] = {"undo": "false"}
    return jsonify(mushroom = mushroom, id = id, mushrooms = mushrooms)

@app.route('/update_info', methods = ['GET', 'POST'])
def update_info():
    json_data = request.get_json()
    id = json_data["Id"]
    updated_info = json_data["info"]
    for i in range(len(mushrooms)):
        if i == id:
            mushroom = mushrooms[i]
            mushrooms[i]["Info"] = updated_info
    return jsonify(mushroom = mushroom)
